    ...
    <body>
        <div class="auth-container">
            ...
            <form action="./register.cgi" method="post">
                <input type="text" name="username" placeholder="ユーザー名" class="auth-input" required>
                <br>
                ...
                <br>
                <input type="text" name="fname" placeholder="名" class="auth-input">
                <br>
                <input type="text" name="lname" placeholder="姓" class="auth-input">
                <br>
                <button type="submit" class="auth-btn">登録する</button>
            </form>
            <div class="auth-toggle">すでにアカウントをお持ちですか？ 
                <a href="./login.cgi">ログイン</a>
            </div>
        </div>
    </body>
</html>
